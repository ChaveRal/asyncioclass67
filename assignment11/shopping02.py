...
async def main():
    ...
    customer_start_time = time.perf_counter()
    customer_product = asyncio.create_task(customer_generation(customer_queue, 4))
...
-------------------------------------------------------------------------------------------
|     3     |   2   |     2     |2  |4.0s |1  |2.0s |   |     |   |     |   |     | 4.07s |
-------------------------------------------------------------------------------------------
|     4     |   2   |     2     |2  |4.0s |2  |4.0s |   |     |   |     |   |     | 4.08s |
-------------------------------------------------------------------------------------------
|     5     |   5   |     5     |1  |2.0s |1  |2.0s |1  |2.0s |1  |2.0s |1  |2.0s | 2.02s |
-------------------------------------------------------------------------------------------
|     10    |   3   |     3     |3  |6.0s |3  |6.0s |4  |8.0s |   |     |   |     | 8.12s |
-------------------------------------------------------------------------------------------
|     10    |   3   |     5     |4  |8.0s |3  |6.0s |3  |6.0s |   |     |   |     | 8.09s |
-------------------------------------------------------------------------------------------
|     20    |   5   |     5     |4  |8.0s |4  |8.0s |4  |8.0s |4  |8.0s |4  |8.0s | 8.11s |
-------------------------------------------------------------------------------------------
'''